...
+ (void)initialize { // todo: 不应该对源方法产生影响
    // 家长端
    [self copyClassMethod:@selector(stGreenColor)
             toClassMethod:@selector(themeGreenColor)
                     error:nil];
    
    [self copyClassMethod:@selector(stOrangeColor)
            toClassMethod:@selector(themeOrangeColor)
                    error:nil];

    [self copyClassMethod:@selector(stBlueColor)
            toClassMethod:@selector(themeBlueColor)
                    error:nil];

    [self copyClassMethod:@selector(stYellowColor)
            toClassMethod:@selector(themeYellowColor)
                    error:nil];
    
    [self copyClassMethod:@selector(stRedColor)
